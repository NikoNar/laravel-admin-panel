...
<link href="{{asset('/harimayco-menu/style.css')}}" rel="stylesheet">
<div id="hwpwrap">
											...
											<ul class="outer-border">
												...
												@if(isset($pages) && !empty($pages))
													<li class="control-section accordion-section  open add-page" id="add-page">
														...
														<div class="accordion-section-content ">
															<div class="inside">
																<div class="pages_for_menu" id="">
																	@foreach($pages as $page)
																		<p id="menu-item-url-wrap">
																			<label class="menu-item-title"><input type="checkbox" class="" name="{{$page->title}}" data-url="{{url('/').'/'.$page->slug}}">{{$page->title}}</label>
																		</p>
																	@endforeach
																	<p class="button-controls">
																		<a  href="#" onclick="addcustommenu('pages')"  class="button-secondary submit-add-to-menu right"  >Add menu items</a>
																		<span class="spinner" id="pages_spinner"></span>
																	</p>
