  <section class="main-header admin-bar">
	<!-- Logo -->
	<div class="logo">
	  ...
	  <span class="logo-lg">
	  	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" width="3.26424in" height="0.400587in" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd; width: 190px; height: 50px;" viewBox="0 0 3649.24 447.83">
	  	 <defs>
	  	  <style type="text/css">
	  	   <![CDATA[
	  	    .fil0 {fill:#fff;fill-rule:nonzero}
	...
	<nav class="navbar navbar-static-top">
	  ...
	  <ul class="nav navbar-nav ">
		<li><a href="{{ url('/admin/dashboard') }}"  target="_blank" class="btn btn-primary btn-flat no-border"> <i class="fa fa-dashboard"></i> Dashboard </a></li>
	  </ul>
	  <div class="navbar-custom-menu">
		<ul class="nav navbar-nav">
			<li class="user user-menu border-left-right ">
				<a href="{{ action('Admin\SettingsController@index') }}" class="btn btn-warning btn-flat no-border " target="_blank" >
				  <span class="hidden-xs text-medium text-uppercase"><i class="fa fa-cogs" aria-hidden="true"></i> Site Settings </span>
				</a>
			</li>
