...
<div class="box">
    ...
    <h1>Translation Manager. <small class="text-danger "><u>Warning! Translations are not visible until publishing.</u></small></h1>
    {{-- they are exported back to the app/lang file, using 'php artisan translation:export' command or --}}
