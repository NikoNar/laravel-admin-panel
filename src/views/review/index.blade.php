	...
	<div class="box">
	    <div class="box-body">
    		...
    		<div id="resource-container">
    			@include('admin-panel::review.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($reviews) && !$reviews->isEmpty() ? class_basename($reviews[0]) : null !!}" >
