...
@if(isset($service)  && !isset($parent_lang_id))
	{!! Form::model($service, ['route' => ['service-update', $service->id], 'method' => 'PUT', 'enctype' => "multipart/form-data"]) !!}
	{!! Form::hidden('id', $service->id) !!}
@elseif(isset($service) && isset($parent_lang_id) )
	{!! Form::model($service, ['route' => 'service-store', 'enctype' => "multipart/form-data", 'method' => 'POST', 'id' => 'service-store']) !!}
	{!! Form::hidden('parent_lang_id', $parent_lang_id) !!}
@else
	{!! Form::open(['route' => 'service-store', 'enctype' => "multipart/form-data", 'method' => 'POST']) !!}
@endif
...
{{--	</div>--}}
	...
	<div class="form-group ">
		@if(isset($languages) && !empty($languages))
			@if(isset($service) && !empty($service))
				<input type="hidden" name="resource_id" value="{{$service->id}}">
			@endif
	...
	<div class="form-group">
		...
		<div class="fileupload fileupload-new" data-provides="fileupload">
			<div class="fileupload-pservice thumbnail" style="width: 100%;">
				@if(isset($service) && !empty($service->thumbnail))
		  			<img src="{{$service->thumbnail}}" class="img-responsive" alt="" onerror="imgError(this);" id="thumbnail-image">
				@else
