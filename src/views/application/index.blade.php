	...
	<div class="box">
	    <div class="box-body">
    		...
    		<div id="resource-container">
    			@include('admin-panel::application.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($applications) && !$applications->isEmpty() ? class_basename($applications[0]) : null !!}" >
