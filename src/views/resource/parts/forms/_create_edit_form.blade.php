...
@if(isset($resource)  && !isset($parent_lang_id))
	{!! Form::model($resource, ['route' => ['resource-update', $resource->id], 'method' => 'PUT', 'enctype' => "multipart/form-data"]) !!}
	{!! Form::hidden('id', $resource->id) !!}
@elseif(isset($resource) && isset($parent_lang_id) )
	{!! Form::model($resource, ['route' => 'resource-store', 'enctype' => "multipart/form-data", 'method' => 'POST', 'id' => 'resource-store']) !!}
	{!! Form::hidden('parent_lang_id', $parent_lang_id) !!}
@else
	{!! Form::open(['route' => 'resource-store', 'enctype' => "multipart/form-data", 'method' => 'POST']) !!}
@endif
...
{{--	</div>--}}
	...
	<div class="form-group">
		...
		<div class="fileupload fileupload-new" data-provides="fileupload">
			<div class="fileupload-presource thumbnail" style="width: 100%;">
