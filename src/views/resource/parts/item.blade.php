<tr data-id="{{ $item->id }}">
	...
	<td class="action">
		<a href="{{ route('resource-edit', $item->id ) }}" title="Edit" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
		...
		<a href="{{ route('resource-destroy', $item->id ) }}" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
	</td>
</tr>