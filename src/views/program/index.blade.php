	...
	<div class="box">
	    <div class="box-body">
	    	...
	    	<div class="col-md-8 no-padding pull-right">
	    		<a href="{{ route("program-create") }}" class="btn btn-primary btn-flat  btn-medium pull-right">Insert New program</a>
    		...
    		<div id="resource-container">
    			@include('admin-panel::program.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($programs) && !$programs->isEmpty() ? class_basename($programs[0]) : null !!}" >
