	...
	<div class="box">
	    <div class="box-body">
	    	...
	    	<div class="col-md-8 no-padding pull-right">
	    		<a href="{{ route("service-create") }}" class="btn btn-primary btn-flat  btn-medium pull-right">Create New Service</a>
    		...
    		<div id="resource-container">
    			@include('admin-panel::service.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($services) && !$services->isEmpty() ? class_basename($services[0]) : null !!}" >
