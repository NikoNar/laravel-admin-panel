	...
	<div class="box">
	    <div class="box-body">
	    	...
	    	<div class="col-md-8 no-padding pull-right">
	    		<a href="{{ route('roles.create') }}" class="btn btn-primary btn-flat  btn-medium pull-right">Create New Role</a>
    		...
    		<div id="resource-container">
    			@include('admin-panel::roles.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($roles) && !$roles->isEmpty() ? class_basename($roles[0]) : null !!}" >
