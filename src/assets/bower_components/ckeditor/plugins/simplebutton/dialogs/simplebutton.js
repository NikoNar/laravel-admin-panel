		...
		contents: [
			{
				...
				elements: [
					...
					},
					{
						...
						commit: function( element ) {
							element.setAttribute( "href", this.getValue()? this.getValue() : "javascript:void(0)" );
