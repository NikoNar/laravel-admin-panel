	...
	<div class="box">
	    <div class="box-body">
	    	...
	    	<div class="col-md-8 no-padding pull-right">
	    		<a href="{{ route('portfolio-create') }}" class="btn btn-primary btn-flat  btn-medium pull-right">Insert New portfolio</a>
    		...
    		<div id="resource-container">
    			@include('admin-panel::portfolio.parts.listing')
    		</div>
	    	
			<input type="hidden" name="modelName" id="modelName" value="{!! isset($portfolios) && !$portfolios->isEmpty() ? class_basename($portfolios[0]) : null !!}" >
